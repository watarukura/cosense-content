...
[redashの引っ越しについて - TORANA TECH BLOG](https://web.archive.org/web/20250120124605/https://tech.torana.co.jp/entry/2023/07/03/120000)
...
```
[https://dev.classmethod.jp/articles/how-to-connect-rds-instance-via-eic-endpoint/](https://dev.classmethod.jp/articles/how-to-connect-rds-instance-via-eic-endpoint/)
...
[https://redash.io/help/open-source/admin-guide/how-to-upgrade](https://redash.io/help/open-source/admin-guide/how-to-upgrade) 公式を参考に、`python manage.py db upgrade` を実行したところ、起動できるようになりました。
